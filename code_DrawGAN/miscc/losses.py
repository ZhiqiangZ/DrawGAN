...
def discriminator_loss(netD, real_imgs, fake_imgs, conditions,
    ...
    #fore_features = netD(fore_imgs)
###########################################################################
    #seg_features = netD(seg_imgs)
...
###########################################################################
    #cond_fore_logits = netD.COND_DNET(fore_features, conditions)
    #cond_fore_errD = nn.BCELoss()(cond_fore_logits, fake_labels)
    #cond_seg_logits = netD.COND_DNET(seg_features, conditions)
    #cond_seg_errD = nn.BCELoss()(cond_seg_logits, fake_labels)
###########################################################################
